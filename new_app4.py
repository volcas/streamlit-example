...
appdata['Datetime'] = pd.to_datetime(appdata['Datetime'],format="%d-%m-%Y %H:%M")
appdata['Datetime'] = appdata['Datetime'].apply(lambda x: datetime.datetime.strftime(datetime.datetime(x, "%d-%m-%Y %H:%M"), "%Y-%m-%d %H:%M")) 
